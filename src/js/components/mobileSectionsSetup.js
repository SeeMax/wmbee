export let mobileSectionsSetup = () => {
  ...
  let myScrollHeight = windowHeight/2;
  ...
  let sec1Lines = $('#section1').find('.single-backline')
  let sec1Arrow = $('#section1').find('.down-arrow-svg')
  gsap.set(sec1Lines, {opacity:0.2});
  gsap.set(sec1Arrow, {opacity:1});
  gsap.set('#background1', {opacity:1, zIndex:100});
  gsap.set('#background3', {zIndex:106});
  gsap.set('#background4', {zIndex:105});
  gsap.set('#background5', {zIndex:104});
  gsap.set('#background6', {zIndex:103});
  gsap.set('#background7', {zIndex:101});

  gsap.set('#overlay1', {opacity:0.65, zIndex:101});
  // gsap.set('#overlay3', {zIndex:103});
  // gsap.set('#overlay4', {zIndex:104});
  gsap.set('#overlay5', {zIndex:105});
  gsap.set('#overlay6', {zIndex:106});
  gsap.set('#overlay7', {zIndex:107});
  ...
  let sec2splitH2 = new SplitText(sec2H2, { type: "lines,words" });
  ...
  let sec4splitH2 = new SplitText(sec4H2, { type: "lines,words" });
  ...
  let sec5splitH2 = new SplitText(sec5H2, { type: "lines,words" });
  ...
  let sec6splitH2 = new SplitText(sec6H2, { type: "lines,words" });
  ...
  let sec7splitH2 = new SplitText(sec7H2, { type: "lines,words" });
  ...
  let sec8splitH2 = new SplitText(sec8H2, { type: "lines,words" });
