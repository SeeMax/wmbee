  ...
  let sectionAnim = {
    ...
    sectionAnim2: () => {
      ...
      let arrowTL = gsap.timeline({
        ...
        onComplete: function () {
          ...
          gsap
            .timeline({ repeat: -1, yoyo: true })
            .to(downArrow, { y: -3, duration: 1, ease: "none" });
        },
        onReverseComplete: function () {
          // Stop Bouncin The Down Arrow and Reset it's Y position
          gsap.killTweensOf(downArrow);
      ...
      tl.to(
        ".header-logo",
        { duration: 0.9, width: 190, ease: "sine.out" },
        "scrollInAll+=0.1"
      );
    ...
    sectionAnim4: () => {
      ...
      arrowTL.fromTo(
        "#bottom-small-2",
        { drawSVG: "50% 50%" },
        { drawSVG: "0% 100%", duration: 0.3, ease: "sine.out" },
        "scrollIn"
      );
      arrowTL.fromTo(
        sectionText,
    ...
    sectionAnim6: () => {
      ...
      lineTL.fromTo(
        [topSmall, bottomSmall, centerSmall],
        { drawSVG: "50% 50%" },
        { drawSVG: "100% 0%" },
        "scrollIn"
      );
      lineTL.fromTo(
        [topLeftSmall, bottomLeftSmall],
        { drawSVG: "50% 50%" },
        { drawSVG: "100% 0%" },
        "scrollIn"
      );
      lineTL.fromTo(
        [topRighttSmall, bottomRighttSmall],
        { drawSVG: "50% 50%" },
        { drawSVG: "100% 0%" },
        "scrollIn"
      );
      ...
      tl.fromTo(
        ".footerArea",
        { y: "100%" },
        { y: 0, duration: 0.7, ease: "back.out(0.5)" },
        "scrollInAll+=0.7"
      );
      // tl.add(arrowTL, "scrollInAll+=0.8");
